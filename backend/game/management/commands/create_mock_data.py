        ...
        charts_data = [
            {
                ...
                'backgroundVideo': '/media/video/background.mp4',
                'coverUrl': '/media/covers/electric_dreams.jpg',
            ...
            },
            {
                ...
                'artist': 'Space Beats',
                'difficulty': 8,
                'song': '/media/songs/cosmic_journey.mp3',
                'backgroundVideo': '/media/video/background.mp4',
                'coverUrl': '/media/covers/cosmic_journey.jpg',
                'isCommunitySong': False,
            },
            {
                'musicId': 'SONG003',
                ...
                'artist': 'Cyber Wave',
                'difficulty': 12,
                'song': '/media/songs/digital_paradise.mp3',
                'backgroundVideo': '/media/video/background.mp4',
                'coverUrl': '/media/covers/digital_paradise.jpg',
                'isCommunitySong': False,
            },
            {
                'musicId': 'SONG004',
                ...
                'artist': 'J-Pop Stars',
                'difficulty': 6,
                'song': '/media/songs/tokyo_nights.mp3',
                'backgroundVideo': '/media/video/background.mp4',
                'coverUrl': '/media/covers/tokyo_nights.jpg',
                'isCommunitySong': False,
            },
            {
                'musicId': 'SONG005',
                'title': 'Hardcore Symphony',
                'artist': 'Metal Fusion',
                'difficulty': 15,
                'song': '/media/songs/hardcore_symphony.mp3',
                'backgroundVideo': '/media/video/background.mp4',
                'coverUrl': '/media/covers/hardcore_symphony.jpg',
                'isCommunitySong': False,
            },
            {
                'musicId': 'COMM001',
                ...
                'difficulty': 7,
                'song': '/media/songs/fan_made_beat.mp3',
                'backgroundVideo': '/media/video/background.mp4',
                'coverUrl': '/media/covers/fan_made_beat.jpg',
